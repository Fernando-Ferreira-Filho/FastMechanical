...
namespace FastMechanical.Models
{
    public class Vendedor {
        ...
        public Vendedor(string nome, long? telefone, string email, string cpf, string rua, string bairro, string estado, string complemento, string cidade, string numero, DateTime? dataDeNascimento, Status status)
        {
            Nome = nome;
            Telefone = telefone;
            Email = email;
